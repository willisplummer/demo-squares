...
},{"callbag-for-each":12,"callbag-from-obs":13,"callbag-from-iter":14,"callbag-from-event":15,"callbag-from-promise":16,"callbag-interval":17,"callbag-map":18,"callbag-scan":19,"callbag-flatten":20,"callbag-take":21,"callbag-skip":22,"callbag-filter":23,"callbag-merge":24,"callbag-concat":25,"callbag-combine":26,"callbag-share":27,"callbag-pipe":28}],6:[function(require,module,exports) {
...
},{"callbag-basics":10}],7:[function(require,module,exports) {
"use strict";var t=require("callbag-basics"),n=["home","about","signup"],e=n.map(function(t){return t+"-bttn"}),r=function(t){window.location.hash=t},i=function(t){var e=t?t.substr(1):"home";document.getElementById(e).classList.remove("hide"),n.filter(function(t){return t!==e}).forEach(function(t){return document.getElementById(t).classList.add("hide")})};(0,t.pipe)((0,t.fromEvent)(document,"click"),(0,t.filter)(function(t){return e.includes(t.target.id)}),(0,t.map)(function(t){return t.target.id.split("-")[0]}),(0,t.forEach)(r));var o=(0,t.concat)((0,t.fromIter)(["pageLoad"]),(0,t.fromEvent)(window,"hashchange"));(0,t.pipe)(o,(0,t.forEach)(function(){return i(window.location.hash)}));
},{"callbag-basics":10}],4:[function(require,module,exports) {
"use strict";var e=require("./squares.js"),r=t(e),u=require("./nav.js"),s=t(u);function t(e){return e&&e.__esModule?e:{default:e}}
},{"./squares.js":6,"./nav.js":7}]},{},[4])
//# sourceMappingURL=/demo-squares/demo-squares.c6c03cd8.map